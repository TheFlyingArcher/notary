...
public class CreateCertificateAuthorityViewModel
{
    ...
    [Required] public bool IsIssuer { get; set; }

    public int KeyLength { get; set; }

    [Required] public Algorithm KeyType { get; set; }

    [Required] public int LengthInMonths { get; set; }

    public string Locale { get; set; }

    [Required]
    [RegularExpression("[a-zA-Z0-9\\-]+", ErrorMessage = "Only alphanumerics plus dashes allowed")]
    ...
    public string? ParentCaSlug
    {
        ...
        {
            _caSlug = value;
            if (OnCertificateAuthoritySlugChanged != null) OnCertificateAuthoritySlugChanged(value);
        }
    }
