...
public partial class CreateCertificateAuthority : ComponentBase
{
    ...
    private CreateCertificateAuthorityViewModel ViewModel { get; } = new();
    ...
    private async Task OnSubmitAsync()
    {
        ...
        var ca = new C.CertificateAuthority
        {
            ...
            DistinguishedName = new C.DistinguishedName
            {
                ...
                Country = ViewModel.SelectedCa != null
                    ? ViewModel.SelectedCa.DistinguishedName.Country
                    : ViewModel.Country,
                Locale =
                    ViewModel.SelectedCa != null ? ViewModel.SelectedCa.DistinguishedName.Locale : ViewModel.Locale,
                Organization = ViewModel.SelectedCa != null
                    ? ViewModel.SelectedCa.DistinguishedName.Organization
                    : ViewModel.Organization,
                OrganizationalUnit = ViewModel.SelectedCa != null
                    ? ViewModel.SelectedCa.DistinguishedName.OrganizationalUnit
                    : ViewModel.OrganizationalUnit,
                StateProvince = ViewModel.SelectedCa != null
        ...
        IsLoading = true;
        await Task.Run(async () => { await CertificateAuthorityService.SaveAsync(ca, null); });
        IsLoading = false;
