...
internal class CertificateRepository : BaseRepository<Certificate, CertificateModel>, ICertificateRepository
{
    ...
    {
        var issuingSlugIndex =
            new CreateIndexModel<CertificateModel>(Builders<CertificateModel>.IndexKeys.Ascending(i => i.IssuingSlug));
        var keySlugIndex =
            new CreateIndexModel<CertificateModel>(Builders<CertificateModel>.IndexKeys.Ascending(k => k.KeySlug));
        var notAfterIndex =
            new CreateIndexModel<CertificateModel>(Builders<CertificateModel>.IndexKeys.Ascending(n => n.NotAfter));
        var notBeforeIndex =
            new CreateIndexModel<CertificateModel>(Builders<CertificateModel>.IndexKeys.Ascending(n => n.NotBefore));
