...
public class IocRegistration : Module, IRegister
{
    protected override void Load(ContainerBuilder builder)
    {
        ...
        builder.Register(r =>
        {
            var cfg = new MapperConfiguration(c => { c.AddProfile<ModelMapProfile>(); });
        ...
        builder.Register(r =>
        {
            ...
            var db = client.GetDatabase(config.Database.DatabaseName);
            return db;
        ...
        builder.RegisterType<CertificateAuthorityRepository>().As<ICertificateAuthorityRepository>()
            .InstancePerLifetimeScope();
        builder.RegisterType<CertificateRepository>().As<ICertificateRepository>().InstancePerLifetimeScope();
        builder.RegisterType<RevocatedCertificateRepository>().As<IRevocatedCertificateRepository>()
            .InstancePerLifetimeScope();
    }
}