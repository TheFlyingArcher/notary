...
public class CertificateAuthorityModel : BaseModel
{
    ...
    [BsonElement("dn")] public DistinguishedNameModel DistinguishedName { get; set; }

    [BsonElement("is_issuer")] public bool IsIssuer { get; set; }

    [BsonElement("issuing_dn")] public DistinguishedNameModel IssuingDn { get; set; }

    [BsonElement("key_alg")] public Algorithm KeyAlgorithm { get; set; }
    ...
    [BsonElement("not_after")] public DateTime NotAfter { get; set; }

    [BsonElement("not_before")] public DateTime NotBefore { get; set; }

    [BsonElement("parent_slug")] public string ParentCaSlug { get; set; }
}