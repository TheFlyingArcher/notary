...
{
    [BsonElement("enc_prv_key")] public string EncryptedPrivateKey { get; set; }

    [BsonElement("alg")] public Algorithm KeyAlgorithm { get; set; }
    ...
    [BsonElement("na")] public DateTime NotAfter { get; set; }

    [BsonElement("nb")] public DateTime NotBefore { get; set; }
}